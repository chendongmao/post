...
<head>
    ...
    <meta charset="UTF-8">
    <title>test</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/back/css/bootstrap.min.css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/back/css/bootstrap-datetimepicker.min.css"/>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/back/js/jquery-3.2.1.min.js"></script>
...
<script type="text/javascript">
    ...
    $("#lo").click(function(){
        ...
        if(code==""){
            ...
            if(sms==code){
                window.location.href="http://localhost:8080/TestCode/jsp/success.jsp";
            alert(sms+登录成功+code);
            }else{
                alert("验证码错误"+sms);
            };
